...
specific PostgreSQL database account.  You can create this via:
  ...
  CREATE DATABASE payment_api_production OWNER payment_api;
  CREATE DATABASE payment_api_test OWNER payment_api;
  CREATE DATABASE payment_api_development OWNER payment_api;
